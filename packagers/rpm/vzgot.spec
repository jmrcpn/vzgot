...
%dir %{_var}/lib/%{name}/vztemplates
%{_var}/lib/%{name}/vztemplates/README
%{_var}/lib/%{name}/contrib/*
%{_usr}/sbin/%{name}
%{_prefix}/libexec/%{name}/bin/vzstat
%{_prefix}/libexec/%{name}/bin/vzmon
...
%{_prefix}/libexec/%{name}/shell/%{name}.boot.Void
...
%{_prefix}/libexec/%{name}/shell/%{name}.create.Void
%{_prefix}/libexec/%{name}/shell/%{name}.destroy
%{_prefix}/libexec/%{name}/shell/%{name}.exec
%{_prefix}/libexec/%{name}/shell/%{name}.freeze
%config(noreplace) %{_prefix}/libexec/%{name}/shell/%{name}.eth.down
%config(noreplace) %{_prefix}/libexec/%{name}/shell/%{name}.eth.up
%{_prefix}/libexec/%{name}/shell/%{name}.list
%{_prefix}/libexec/%{name}/shell/%{name}.offboot
%{_prefix}/libexec/%{name}/shell/%{name}.onboot
...
#-----------------------------------------------------------------------------
%description            openrc
This package allow to use vzgot on openrc init system.
...
#-----------------------------------------------------------------------------
%changelog
* Mon Sep 14 2026 Jean-Marc Pigeon <jmp@safe.ca> - 26.09.62-1
